...
public interface Interval<T> extends Predicate<T> {
   ...
   * the interval) or closed (i.e., included in the interval).
   * <p>
   * By convention, the lower bound of the empty interval is closed.
   *
   ...
   * the interval) or closed (i.e., included in the interval).
   * <p>
   * By convention, the upper bound of the empty interval is open.
   *
