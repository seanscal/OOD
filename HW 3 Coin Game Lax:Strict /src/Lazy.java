...
public final class Lazy<T> implements Supplier<T> {
   ...
   *          This will be maintained through any public calls to the Lazy class.
   */
   ...
   * If the thunk assignment and the value assignment were switched, both value and thunk would
   *    always end up null because thunk would be set to null before it's value was stored.
   *    This will end in a Null Pointer Exception being thrown due to the invariant for the class.
   */
  public void force() {
    if (thunk != null) {
      value = thunk.get();
